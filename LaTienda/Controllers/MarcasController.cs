...
namespace LaTienda.Controllers
{
    ...
    public class MarcasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Codigo,Descripcion")] Marca marca)
        {
            if (ModelState.IsValid)
            {
                marca.Codigo = Guid.NewGuid();
                _context.Add(marca);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("Codigo,Descripcion")] Marca marca)
        {
            if (id != marca.Codigo)
            {
                return NotFound();
